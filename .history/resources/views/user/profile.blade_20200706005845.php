...
<div id="page-wrapper">
     <div class="col-md-12 graphs">
        ...
        <form class="form-floating ng-pristine ng-invalid ng-invalid-required ng-valid-email ng-valid-url ng-valid-pattern" novalidate="novalidate" action="" method="POST">
        @csrf
          <fieldset>
